...
-- RelaciÃ³n entre insumos y proveedores
...
-- RelaciÃ³n entre insumos y recetas
...
CREATE TABLE DetalleVenta (
  ...
  FOREIGN KEY (venta_id) REFERENCES ModuloVentas(id),
  FOREIGN KEY (receta_id) REFERENCES Recetas(id)
);
...
AFTER INSERT ON ModuloProduccion
FOR EACH ROW
BEGIN
...
('ProducciÃ³n Don Galleto', 'produccion@dongalleto.com', 'password123', 2),
...
('Proveedor Harinas MX', 'Juan PÃ©rez', '5551234567', 'juan@harinasmx.com', 'Av. Central', 'Centro', 12345, 10),
('Proveedor Huevo Express', 'MarÃ­a LÃ³pez', '5559876543', 'maria@huevoexpress.com', 'Calle Norte', 'Industrial', 67890, 20);
...
INSERT INTO AdministracionInsumos (insumo_nombre, tipo_insumo_id, cantidad_existente, unidad, lote_id, fecha_registro, fecha_caducidad) VALUES 
('Harina de trigo', 1, 100.00, 'kg', 'L001', '2024-03-01', '2024-06-01'),
('Huevo fresco', 2, 200.00, 'pza', 'L002', '2024-03-01', '2024-04-15'),
('AzÃºcar blanca', 4, 50.00, 'kg', 'L003', '2024-03-01', '2024-07-01'),
('Mantequilla sin sal', 3, 30.00, 'kg', 'L004', '2024-03-01', '2024-05-10');

-- Insertar relaciÃ³n entre insumos y proveedores
...
(1, 3, 15.00, 'kg'), -- AzÃºcar blanca por Proveedor Harinas MX
...
-- Insertar producciÃ³n de galletas
INSERT INTO ModuloProduccion (receta_id, cantidad_producida, fecha_produccion, caducidad, merma, motivo_merma, cantidad_disponible) VALUES 
(1, 100, '2024-03-15', '2024-03-25', 5, 'Rotura', 95),
(2, 120, '2024-03-16', '2024-03-26', 3, 'Forma defectuosa', 117);

-- Insertar estado de pedidos
...
-- Insertar ventas
INSERT INTO ModuloVentas (usuario_id, total_venta, descuento_aplicado, cliente_pago, cambio, fecha_venta) VALUES 
...
-- Insertar insumos recibidos
INSERT INTO InsumosRecibidos (lote_id, fecha_recepcion, fecha_caducidad, cantidad, precio_unitario, insumo_id, proveedor_id) VALUES 
('L001', '2024-03-10', '2024-06-01', 50, 18.50, 1, 1), -- Harina de trigo recibida
('L002', '2024-03-12', '2024-04-15', 100, 4.80, 2, 2); -- Huevo fresco recibido

-- Insertar merma de insumos
INSERT INTO MermaInsumos (cantidad_danada, motivo_merma, insumo_id) VALUES 
(2.00, 'Derrame en almacÃ©n', 1), -- Merma de Harina de trigo
(5.00, 'CÃ¡scara rota', 2); -- Merma de Huevo fresco
